...
;; Determine name of Vulkan library
(: libname Path)
(define libname (case (system-type 'os)
                  [(windows) (string->path "vulkan")]
                  [else (string->path "libvulkan")]))

;; Vulkan Interface: `vki`
(: vki FFI-Lib)
(define vki (ffi-lib libname))



;; Objects defined from `vki`

#|
(define _vk-structure-type
  (get-ffi-obj "VkStructureType"
               vki
               (_enum '(VK_STRUCTURE_TYPE_APPLICATION_INFO 
                        = 0
