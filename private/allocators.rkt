...
; array allocators
;
(define (A* ctype length) (malloc (_array ctype length)))
...
;; C constants
;;
; a ptr to a uint32 containing zero
(define vkzero (let ([ret (A-uint32)]) (ptr-set! ret _uint32 0) ret))
